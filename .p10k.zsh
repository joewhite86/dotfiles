# Generated by Powerlevel10k configuration wizard on 2020-09-09 at 23:14 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=12
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local conflicted='%124F'  # red foreground
    else
